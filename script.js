  ...
  c.innerHTML=list.map(r=>{
    ...
    return '<div class="resa-row'+(r.rachel?' resa-row-rachel':'')+'">'+ 
      '<div class="resa-row-left">'+
        '<div class="resa-row-name">'+(r.options&&r.options['o6']?'<span style="color:#1A5F9E;font-weight:700;">':'')+x(fn(r))+(r.options&&r.options['o6']?'</span>':'')+(r.nbPersonnes&&r.nbPersonnes>1?' <span style="font-size:11px;color:var(--gray-400);">👥 '+r.nbPersonnes+' pers.</span>':'')+(r.rachel?' <span class="rachel-badge">👩 Assignée à Rachel</span>':'')+'</div>'+
  ...
  return '<div class="rachel-card'+(r.rachel?' rachel-card-highlighted':'')+'" data-id="'+r.id+'">'+
    '<div class="rachel-card-header">'+
      '<div class="rachel-card-client">'+
        '<div class="rachel-client-name">'+(r.options&&r.options['o6']?'<span style="color:#1A5F9E;font-weight:700;">':'')+x(fn(r))+(r.options&&r.options['o6']?'</span>':'')+(r.nbPersonnes&&r.nbPersonnes>1?' <span style="font-size:11px;color:var(--gray-400);">👥 '+r.nbPersonnes+' pers.</span>':'')+(r.rachel?' <span class="rachel-badge">👩 Assignée à Rachel</span>':'')+'</div>'+
